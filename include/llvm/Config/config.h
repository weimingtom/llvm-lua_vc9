...
#define LLVM_PATH_CIRCO "C:/Program Files/Graphviz2.26.3/bin/circo.exe"

/* Define to path to dot program if found or 'echo dot' otherwise */
#define LLVM_PATH_DOT "C:/Program Files/Graphviz2.26.3/bin/dot.exe"

/* Define to path to dotty program if found or 'echo dotty' otherwise */
#define LLVM_PATH_DOTTY "C:/Program Files/Graphviz2.26.3/bin/dotty.exe"

/* Define to path to fdp program if found or 'echo fdp' otherwise */
#define LLVM_PATH_FDP "C:/Program Files/Graphviz2.26.3/bin/fdp.exe"
...
#define LLVM_PATH_NEATO "C:/Program Files/Graphviz2.26.3/bin/neato.exe"

/* Define to path to twopi program if found or 'echo twopi' otherwise */
#define LLVM_PATH_TWOPI "C:/Program Files/Graphviz2.26.3/bin/twopi.exe"
