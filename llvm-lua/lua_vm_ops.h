...
#ifdef _MSC_VER
//这里的_declspec(dllexport) extern不同于_declspec(dllexport)
//可以避免vm_op_functions的符号重复
#define extern _declspec(dllexport) extern
#endif
...
#else
//57
extern const vm_func_info vm_op_functions[58];
#endif
